...
Sempre utilize o padrão [Conventional Commits](https://www.conventionalcommits.org/pt/v1.0.0/) para todas as mensagens de commit. Isso garante organização, rastreabilidade e facilita automações.
